...
class SeccionsControllerTest < ActionController::TestCase
  ...
  test "should create seccion" do
    assert_difference('Seccion.count') do
      post :create, seccion: { sec_descripcion: @seccion.sec_descripcion, sec_seccion: @seccion.sec_seccion }
    end
  ...
  test "should update seccion" do
    patch :update, id: @seccion, seccion: { sec_descripcion: @seccion.sec_descripcion, sec_seccion: @seccion.sec_seccion }
    assert_redirected_to seccion_path(assigns(:seccion))
  end
