class TrabajadorsController < ApplicationController
  ...
  def destroy
    @trabajador.destroy
    respond_to do |format|
      format.html { redirect_to trabajadors_url }
  ...
  private
    ...
    def trabajador_params
      params.require(:trabajador).permit(:tra_rut, :tra_nombre, :tra_apellidop, :tra_apellidom, :tra_nacimiento, :tra_telefono, :tra_direccion, :tra_numero, :tra_email, :tra_sexo)
    end
end
